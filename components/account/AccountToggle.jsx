...
function AccountToggle() {
  ...
  return (
    <div className="account_toggle flex justify-center items-center">
      <div className={`${dropActive && "drop_opened"} account_drop`} ref={accountRef}>
          ...
          {isAuth ? (
            <div className="drop_ist" onClick={e => e.stopPropagation()}>
              <div className="drop_inner">
                <div className="border-[#D3BA87] border-b-2 pb-[5px]">{`Hi ${user?.name || "User"}`}</div>
                <div className="mt-[10px]"> My Account</div>
                <div className="p-[10px] mt-[10px]  duration-300 cursor-pointer hover:opacity-50" onClick={handleLogout}> Logout </div>
              </div>
            </div>
          ) : (
            <div className="drop_ist">
              <div className="drop_inner">
                <div className="border-[#D3BA87] border-b-2 pb-[5px]">My Account</div>
                <a href="/" className=" mt-[10px] whitespace-nowrap" onClick={(e) => registerPopupOpen(e)} >
                  Create Account
                </a>
                <a href="/" className="mt-[10px]" onClick={(e) => loginPopupOpen(e)}>
                  Sign In
                </a>
              </div>
            </div>
