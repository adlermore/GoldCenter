  ...
  return (
    <>
      {activePopup === 'register' &&
        <div className="register_popup fixed left-0 right-0 bottom-0 flex items-center justify-center pl-[17px] duration-500 transition-[top] top-[-100%] w-full h-full z-[999] overflow-x-hidden overflow-y-auto bg-black bg-opacity-20 tablet:!p-20 tablet:h-[100dvh]">
            ...
            <div className="register_form">
              <form onSubmit={handleSubmitForm(registerSubmit)} className="w-full">
                <div className={errorsRegister?.name ? "form_block has_error" : "form_block"}>
                  <div className="registerForm_label text-base font-semibold mb-[5px]">
                ...
                <div className={errorsRegister?.email_or_phone ? "form_block has_error" : "form_block"}  >
                  <div className="registerForm_label text-base font-semibold mb-[5px]">
